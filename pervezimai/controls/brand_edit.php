...
<?php
	...
	$required = array('pavadinimas','salis');
	...
	<form action="" method="post">
		<fieldset>
			...
			<p>
				...
				<label class="field" for="name">Šalis<?php echo in_array('salis', $required) ? '<span> </span>' : ''; ?></label>
				
				<input type="text" id="country" name="salis" class="textbox-150" value="<?php echo isset($fields['salis']) ? $fields['salis'] : ''; ?>">
				<?php if(key_exists('salis', $maxLengths))echo "<span class='max-len'>(iki {$maxLengths['salis']} simb.)</span>"; ?>
