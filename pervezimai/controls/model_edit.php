...
<?php
	...
	$required = array('pavadinimas', 'fk_MARKEid_MARKE');
	...
	if(!empty($_POST['submit'])) {
		...
		$validations = array (
			...
			'fk_MARKEid_MARKE' => 'positivenumber'
			);
...
<ul id="pagePath">
	...
	<li><a href="index.php?module=<?php echo $module; ?>">Vilkikų modeliai</a></li>
...
<div id="formContainer">
	...
	<form action="" method="post">
		<fieldset>
			...
			<p>
				<label class="field" for="brand">Markė<?php echo in_array('fk_MARKEid_MARKE', $required) ? '<span> *</span>' : ''; ?></label>
				<select id="brand" name="fk_MARKEid_MARKE">
					...
					<?php
						...
						foreach($brands as $key => $val) {
							$selected = "";
							if(isset($fields['fk_MARKEid_MARKE']) && $fields['fk_MARKEid_MARKE'] == $val['id']) {
